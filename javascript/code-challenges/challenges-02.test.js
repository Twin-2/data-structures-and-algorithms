...
const raisedToTheThird = (arr) => {
  let raisedNum = [];
  arr.forEach(item => raisedNum.push(Math.pow(item, 3)));
  return raisedNum;
};
...
const addOne = (arr) => {
  let newNumbers = arr.map( (value) => value + 1);
  return newNumbers;
};
...
const addQuestion = (arr) => {
  let newStrings = arr.map( (string) => string + '?');
  return newStrings;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for(let i=0; i<arr.length; i++){
    let mathed = Math.pow(2, arr[i]);
    newNumber.push(mathed);
  }
  return newNumber;
};
...
const forEachTwoToThe = (arr) => {
  let newNumber = [];
  arr.forEach(value => newNumber.push(Math.pow(2, value)))
  return newNumber;
};
...
const mapTwoToThe = (arr) => {
  let newNumber = arr.map( (value) => Math.pow(2, value));
  return newNumber;
};
